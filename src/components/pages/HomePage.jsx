        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-10 lg:px-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8">
            ...
            <FadeInOnScroll delay={0.2} className="lg:col-span-6">
              <HoverLiftCard className="bg-[#D9C7B8] border border-[#A67C52]/20 hover:border-[#A67C52]/30 transition-all duration-300 group p-6 sm:p-8 flex flex-col justify-between">
            ...
            <FadeInOnScroll delay={0.3} className="lg:col-span-6">
              <HoverLiftCard className="bg-[#D9C7B8] border border-[#8B6639]/40 hover:border-[#8B6639]/60 transition-all duration-300 group p-6 sm:p-8 flex flex-col justify-between">
                <div className="flex items-start justify-between mb-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <FadeInOnScroll className="lg:col-span-6 flex flex-col space-y-6">
              ...
              <div className="space-y-4 pt-2">
                <FadeInOnScroll delay={0.1} className="flex items-start gap-4 p-4 bg-[#D9C7B8] border border-[#A67C52]/20 rounded-xs hover:border-[#A67C52]/40 transition-colors">
                ...
                <FadeInOnScroll delay={0.2} className="flex items-start gap-4 p-4 bg-[#D9C7B8] border border-[#A67C52]/20 rounded-xs hover:border-[#A67C52]/40 transition-colors">
                  <div className="p-2 bg-[#A67C52]/20 text-[#A67C52] rounded-xs shrink-0 mt-0.5">
                ...
                <FadeInOnScroll delay={0.3} className="flex items-start gap-4 p-4 bg-[#D9C7B8] border border-[#A67C52]/20 rounded-xs hover:border-[#A67C52]/40 transition-colors">
                  <div className="p-2 bg-[#A67C52]/20 text-[#A67C52] rounded-xs shrink-0 mt-0.5">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-10 lg:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
            {TESTIMONIALS.map((item) => (
              <div
                key={item.id}
                className="bg-[#D9C7B8] border border-[#A67C52]/20 p-6 sm:p-8 flex flex-col justify-between relative hover:border-[#A67C52]/30 hover:shadow-lg transition-all"
              >
                <div>
