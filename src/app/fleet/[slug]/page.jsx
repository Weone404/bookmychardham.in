...
const fleetVideoUrl = 'https://www.youtube.com/embed/Bw1ldiDqAIk';
    ...
    <div className="min-h-[60vh] bg-[#F3E9D0] text-[#6B4E3D]">
      <section className="relative overflow-hidden border-b border-[#A67C52]/20 bg-[#D9C7B8]">
        <iframe
          ...
          src={`${fleetVideoUrl}?autoplay=1&mute=1&controls=0&loop=1&playlist=Bw1ldiDqAIk&rel=0&playsinline=1`}
