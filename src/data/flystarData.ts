...
export const CHARDHAM_PACKAGES: HelicopterPackage[] = [
  {
    ...
    highlights: [
      ...
      'Dedicated FlyStar ground executive assistance at Kedarnath Helipad',
...
export const BASE_LOCATIONS: BaseLocation[] = [
  {
    ...
    helipadName: 'FlyStar Terminal 2, Sahastradhara Helidrome',
  ...
  },
  {
    ...
    helipadName: 'FlyStar Helidrome Sersi',
...
export const TESTIMONIALS: TestimonialItem[] = [
  {
    ...
    quote: 'Our parents (aged 76 and 72) had been dreaming of visiting Yamunotri and Kedarnath for decades. FlyStar made it as effortless as a blessing. The VIP Darshan pass meant no waiting in 8-hour queues, and the luxury stays at Harsil were breathtaking.',
    rating: 5,
    date: 'May 2026',
  },
  {
    ...
    quote: 'We had to inspect 3 remote hydroelectric project sites across Himachal and Uttarakhand in a single day. FlyStar handled DGCA clearances, helipad marshaling, and flight timing with military precision. Saved us at least 3 days of travel.',
    rating: 5,
    date: 'June 2026',
  },
  {
    ...
    quote: 'The aerial flower dropping during our Varmala at Jagmandir Palace was the absolute highlight of our wedding! Thousands of fresh rose petals floating down in the sunset light. FlyStar coordinated all permissions flawlessly.',
    rating: 5,
    date: 'February 2026',
  },
];
